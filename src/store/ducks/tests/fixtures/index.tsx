...
import { PregnancyLogFaceSms, NutritionLogFaceSms, SmsData } from 'store/ducks/sms_events';
...
export const PregnancyReportFixture = superset.processData(pregnancyReportJson) as PregnancyLogFaceSms[];
