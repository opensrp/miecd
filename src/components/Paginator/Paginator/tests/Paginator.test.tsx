...
describe('src/components/paginator - rendering', () => {
    ...
    it('Maintains active and disabled fields status correctly', () => {
        ...
        // go to the 3rd page
        PIWrapper.at(4).find('PaginationLink a').simulate('click');
        ...
        // go to the last page
        PIWrapper.at(8).find('PaginationLink a').simulate('click');
    ...
    it('clicking next & start link work correctly', () => {
        ...
        wrapper.update();
        expect(wrapper.find('PaginationItem').at(3).hasClass('active')).toBeTruthy();

        // clicking start takes you to start page
        const startPageAt = 2;
        const startItem = wrapper.find('PaginationItem').at(0).find('PaginationLink a');
        startItem.simulate('click');
        wrapper.update();
        expect(wrapper.find('PaginationItem').at(startPageAt).hasClass('active')).toBeTruthy();
    });
    ...
    it('clicking end link work correctly', () => {
        ...
        wrapper.update();
        expect(wrapper.find('PaginationItem').at(4).hasClass('active')).toBeTruthy();
    ...
    it('calls pageChangeHandler with correct args', () => {
        ...
        PIWrapper.at(5).find('PaginationLink a').simulate('click'); // click on next
